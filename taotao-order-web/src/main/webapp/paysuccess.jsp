...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="/css/wx/pages-paysuccess.css" />
	...
	<body>
		...
		<div class="cart py-container">
			...
			<div class="paysuccess">
				<div class="success">
					<h3><img src="/images/right.png" width="48" height="48">　恭喜您，支付成功啦！</h3>
					<div class="paydetail">
					<p>支付方式：微信支付</p>
					<p>支付金额：￥<span id="t_id"></span>元</p>
					<p class="button"><a href="myOrder.html" class="sui-btn btn-xlarge btn-danger">查看订单</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost:8082" class="sui-btn btn-xlarge ">继续购物</a></p>
				    </div>
				</div>
...
<script type="text/javascript">
	...
	var result = getRequestParam();
	$("#t_id").html(result['total_fee']);
