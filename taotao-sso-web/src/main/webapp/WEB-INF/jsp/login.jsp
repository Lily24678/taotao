        ...
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                <div class="item fore1">
                    <span>用户名</span>
                    <div class="item-ifo">
                        <input onkeydown="javascript:if(event.keyCode==13) LOGIN.login();" type="text" id="loginname" name="username" class="text"  tabindex="1" autocomplete="off"/>
                ...
                <div class="item fore2">
                    <span>密码</span>
                    <div class="item-ifo">
                        <input onkeydown="javascript:if(event.keyCode==13) LOGIN.login();" type="password" id="nloginpwd" name="password" class="text" tabindex="2" autocomplete="off"/>
